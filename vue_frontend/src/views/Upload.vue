  ...
  <div class="upload-page">
      ...
      <el-col :xs="22" :sm="18" :md="14" :lg="12">
        <el-card class="upload-card">
          <div class="card-header">
            <h2>上传学生数据</h2>
            <p class="sub">
              支持 Excel / CSV 文件，上传后会触发预测与可视化分析
            </p>
          </div>
          ...
          <div class="upload-area">
            ...
            >
              ...
              <div class="el-upload__tip">
                建议一次上传不超过 10MB；登录后可保存结果
              </div>
            </el-upload>

            <div v-if="!token" class="login-hint">
              <el-alert
                title="未登录：上传将作为匿名请求，登录可保存记录"
                type="warning"
                show-icon
                closable
              />
    ...
    <div v-if="predictionResult" class="results-wrap">
              ...
              >
                <div class="metric">
                  ...
                  <div class="metric-value">
                    {{ formatNumber(predictionResult.metrics[key]) }}
                  </div>
                </div>
              </el-col>
            </el-row>
      ...
      <el-row :gutter="20" style="margin-top: 16px">
        <el-col
          v-if="predictionResult.visualizations.prediction_scatter"
          :xs="24"
          :md="12"
        >
          <el-card>
            ...
            <img
              :src="
                ...
                predictionResult.visualizations.prediction_scatter
              "
              alt="scatter"
              style="width: 100%"
            />
        ...
        <el-col
          v-if="predictionResult.visualizations.feature_importance"
          :xs="24"
          :md="12"
        >
          <el-card>
            ...
            <img
              :src="
                'data:image/png;base64,' +
                predictionResult.visualizations.feature_importance
              "
              alt="feature"
              style="width: 100%"
            />
          ...
          onUploadProgress: (e) => {
            if (e.total)
              this.progress = Math.min(
                90,
                Math.round((e.loaded / e.total) * 80) + 10,
              );
          },
        });
