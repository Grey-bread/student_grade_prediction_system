...
OUT_PATH_PUBLIC = os.path.join(
    ROOT_DIR, "vue_frontend", "public", "data", "students.csv"
)
...
given_first = list(
    "一二三四五六七八九子文思明志宇浩锦瑞嘉晨景泽梓若欣雅乐杰星佳浩睿雨涵颖奕宁博凯彦昭启腾羽清瑜乐珂祺宸曜序宥泓茗琛珺瑾渲淇沁语嫣奚岚霖露宁依菲璇妍婕婷莹雪芸颖姝彤瑶琳筱林翊"
)

given_second = list(
    "一二三四五六七八九子文明志宇浩然轩琛睿泽妍涵怡欣宁晨熙琪瑶瑾渝珂悦珊娜琳蓉婧萱芸洁琪瑜璐钰霖雪彤琪翎希凝萌蕾珏煜茹芷函颖滢娅雯可扬腾焱亦致恺昊祺诺辰博衡晟帆哲坤峻磊航斌霄阳潇凯衡驰驰骁御铠锴骞骐馥"
)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--count", type=int, default=10000, help="Number of student records to generate"
    )
